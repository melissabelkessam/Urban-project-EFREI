...
BASE_URL = os.getenv("TYPOLOGIE_API_BASE")
DATASET = os.getenv("TYPOLOGIE_DATASET")
...
print("⏳ Récupération de la typologie des logements en cours...")
...
if response.status_code == 200:
    ...
    output_file = bronze_path / "typologie_logements.json"
